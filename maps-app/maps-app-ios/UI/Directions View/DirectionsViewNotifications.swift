...
extension MapsAppNotifications {
    static func observeManeuverFocusNotifications(owner: Any, maneuverFocusNotificationHandler:@escaping ((_ maneuver: AGSDirectionManeuver) -> Void)) {
        let ref = NotificationCenter.default.addObserver(forName: MapsAppNotifications.Names.ManeuverFocus, object: nil, queue: nil) { notification in
...
private struct DirectionsViewNotificationKeys {
